...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                .antMatchers("/registration").hasAnyAuthority("SUPERADMIN") // accès pour tous users
                .antMatchers("/role/**").hasAnyAuthority("SUPERADMIN")
                .antMatchers("/accounts/**").hasAnyAuthority("SUPERADMIN")
                
                
                .antMatchers("/fournisseur/add").hasAnyAuthority("ADMIN")
                .antMatchers("/fournisseur/list").hasAnyAuthority("ADMIN","SUPERADMIN")
                .antMatchers("/fournisseur/edit/{id}").hasAnyAuthority("ADMIN")
                
                
                
                .antMatchers("/produit/add").hasAnyAuthority("ADMIN")
                .antMatchers("/produit/edit/{id}").hasAnyAuthority("ADMIN")
                .antMatchers("/produit/list").hasAnyAuthority("ADMIN","SUPERADMIN","AGENT").anyRequest()
